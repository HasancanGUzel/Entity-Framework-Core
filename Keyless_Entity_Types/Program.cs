...
namespace Keyless_Entity_Types;
class Program
{
    ...
    static void Main(string[] args)
    {
       #region Keyless Entity Types
        ...
        //*Change Tracker mekanizması aktif olmayacaktır.(delete ,insert, update) geçerli olmaz
...
[Keyless]
public class PersonOrderCount //*keyless için entity tanımlıyoruz
{
...
class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PersonOrderCount>()
            .HasNoKey()
            .ToView("vw_PersonOrderCount"); //*viewi bildiriyoruz ve primary key olmadığını belirtiyoruz.
    }
