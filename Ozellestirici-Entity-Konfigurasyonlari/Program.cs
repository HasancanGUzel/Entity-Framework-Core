...
namespace Ozellestirici_Entity_Konfigurasyonlari;
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        //*Generate edilecek tablonun ismini belirlememizi sağlayan yapılandırmadır.(Db set içinde entitinin çoğul olarak isimlendirdiğimiz isimden bahsediyoruz)
        ...
        //*Biz hangi yolu kullanırsak kullanalım fluent api da da tablo ismi verisek ef core fluent api baz alır
        #endregion
        ...
        //*Flight ve airport entitsinde gösterdik oraya bak
        #endregion
        ...
        #region HasValue
            //*bunuda hasdicriminator ile beraber görücez daha detaylı
        #endregion
        ...
        //bir tabloda index kullanamk istiyorsak kullanırız.
        #endregion
        ...
        #region DatabaseGenerated - ValueGeneratedOnAddOrUpdate, ValueGeneratedOnAdd, ValueGeneratedNever
                //* sonra bir sonraki ders bakacağız
        #endregion
        #endregion
...
[Table("Kisiler")] //*tabolomuzun adını buradan istediğimiz gibi verebiliriz.Bunun yerine modelcreating içinde de kullanabiliriz aşşağıda var.
class Person
{
    [Key]
    public int Id { get; set; } //*primary key yapıyoruz yani bunu başka bir isimde verip de primary key yapabiliriz.
    public int Id2 { get; set; }//*ıd ile birlikte ıd2 nin primary key olmasını istiyorsak  composit key kullanırız aşşağıda fluent api olarak kullandık
    
    [ForeignKey(nameof(Department))] //*foreign keyi biz kendimiz başka isimde koyacaksak böyle koyabiliriz .
    public int DId { get; set; }

    public int DepartmentId { get; set; }

    [Column("Adi", TypeName = "metin", Order = 7)] //* oluşturulacak kolonları propert isimleri değilde başka isim vermek istiyorsak ya buradan verebiliriz ya da onmodelcreatinde verebiliriz.

   
    public string _name;
    public string Name { get => _name; set => _name = value; }//*bavking field özelliği için aşşağıda fluent api HasField içinde
    ...
    [Precision(5, 3)] //* 12.356987 5,3   şimdi 5 haneliyse noktadan sonraki 3 haneyi al diyoruz. 
    public decimal Salary { get; set; }

    //Yazılımsal amaçla oluşturduğum bir property
    [NotMapped] //*bu kolonu migrate ettiğin zaman veritabanına kolon olarak ekleme diyoruz
...
class ApplicationDbContext : DbContext
{
    ...
    {
        #region GetEntityTypes
        //var entities = modelBuilder.Model.GetEntityTypes(); //*entitlerimizi elde etmek için yapıyoruz
        //foreach (var entity in entities) //*migration yaptığımızda entitlerimizin isimlerini yazdırdık istersek baişka birşeyde yapabiliriz.
        //{
        //    Console.WriteLine(entity.Name);
        //}
        #endregion
        #region ToTable
        //modelBuilder.Entity<Person>().ToTable("aksdmkasmdk"); //*burada da tablo adını belirleyebiliriz.Eğer burada tablo ismi verirsek ef core yukarıda verdiklerimizi ezer yani bunu baz alır  
        #endregion
        #region Column
        //* kolon isimlerini buradan da verebiliriz eğer buradan isim veriyorsak  yukarıdaki verdiğimiz isimleri ezer burayı baz alır.
        ...
        #endregion
        #region ForeignKey
        //modelBuilder.Entity<Person>() //*foreign keyi herzamn bildiğimiz gibi buradan da koyabiliriz.
        //    .HasOne(p => p.Department)
        //    .WithMany(d => d.Persons)
        //    .HasForeignKey(p => p.DId);
        #endregion
        #region Ignore
        //modelBuilder.Entity<Person>() //*veritabanına entitimdeki bu kolonu kolon olarak eklemek istemiyorum dedik.
        //    .Ignore(p => p.Laylaylom);
        #endregion
        #region Primary Key
        //modelBuilder.Entity<Person>() //*veya buradan da primary key kolonunu belirleyebiliriz.
        //    .HasKey(p => p.Id);
        #endregion
        #region IsRowVersion
        //modelBuilder.Entity<Person>()
        ...
        //modelBuilder.Entity<Person>().HasKey(p => new { p.Id, p.Id2 }); //* 2 kolonuda primary key yapmış olduk
        #endregion
        #region HasDefaultSchema
        ...
        //modelBuilder.Entity<Person>()
        // .Property(p => p.Salary)
        // .HasDefaultValue(100); //*salary ile yapılan tüm çalılşmalarda default olarak 100 değeri atanıcak yani hiçbir değer atamazsak 100 olarak gözükecek.
        #endregion
        #region HasDefaultValueSql
        //modelBuilder.Entity<Person>()
        //    .Property(p => p.CreatedDate)
        //    .HasDefaultValueSql("GETDATE()");//*bu kolona değeri sql den göndericez.
        #endregion
        #endregion
        #region HasComputedColumnSql
        //modelBuilder.Entity<Example>()
        //    .Property(p => p.Computed)
        //    .HasComputedColumnSql("[X] + [Y]"); //*x ve y kolonunun toplamını computed kolonuna yazıyor
        #endregion
        #region HasConstraintName
        //modelBuilder.Entity<Person>()
        //    .HasOne(p => p.Department)
        ...
        //    .HasValue<A>(1)
        //    .HasValue<B>(2)
        //    .HasValue<Entity>(3); //* bunu ileride görücez şuan bende anlamadım derinlemesine inceleyeceğiz
