...
namespace Complex_Query_Operators_Inner_Left_Right_Full_CrossJoins;
class Program
{
    ...
    static void Main(string[] args)
    {
        #region Complext Query Operators
            ...
            #region Join
                ...
                //            join order in context.Orders
                //                on person.PersonId equals order.PersonId into personOrders//*into dedikden sonra group join yapmış oluyorum
            ...
            //*lefft veya right joinde method syntax kullanılmıyor.
            #region Left Join
            //var query = from person in context.Persons
            //            join order in context.Orders
            ...
            //*ilk önce left joion sonra right join yaptık en sonunda 2 sini birleştirik full join oldu
            #endregion
            ...
            //var datas = await query.ToListAsync();
            //*sorguda from dedikden sonra join yerine tekrar from dedik cross join olduğunu anladı
            #endregion
            ...
            //var datas = await query.ToListAsync();
            //*where koşulu koyduk ve inner join olarak algıladı
            #endregion
