...
namespace Stored_Procedure_Olusturma;
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        //*1. adım : boş bir migration oluşturunuz.(store2 adında oluşturdum)
        ...
        #endregion
        #endregion
        #region Geriye Değer Döndüren Stored Procedure'ü Kullanma (mig store3 de yazdık)
...
[NotMapped] //*bu entity tablo olmayacak dedik veritabanında tablo oluştrumyacak
public class PersonOrder //*store procedure için yaptık
{
    public string Name { get; set; }
