...
namespace Sql_Queries_FromSqlInterpolated_FromSql_FromSqlRaw_SqlQuery;
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        //    .ToListAsync();
            //*@PersonId    //SqlParameter value = new("PersonId", "3"); içindeki PersonId ile aynı isimde olması lazım
