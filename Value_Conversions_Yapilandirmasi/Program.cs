...
namespace Value_Conversions_Yapilandirmasi;
class Program
{
...
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //    .HasConversion(
        //        //INSERT - UPDATE
        //        //g =>g //*böylede yazabiliriz  sana kalmış
        //        g => g.ToUpper() //*g verisini büyük harfe dönüştütrrerek veritabanına
        //    ,
        //        //SELECT
        //        g => g == "M" ? "Male" : "Female"
        //    );
        ...
        //   .HasConversion(
        //       //INSERT - UPDATE
        //       g => g.ToString() //*gender enum olduğu için string veya int e çevirdik 
        //       //g => (int)g //*int de gender değerleri 0,1,2,3, diye gittiği için o değerleri alacağız
        //   ,
        //       //SELECT
        //       g => (Gender)Enum.Parse(typeof(Gender), g) //*enum a parse ediyoruz hangi enum a dönüştüreceksek type ını giricez typeof diyerek Gender type girdik ve hangi veriyi dönüştürücez ona da g yi girdik. Normalde enum.parse bize veriyi object olarak vereceğinden başına Gender yazıyoruz gender türünde versin diye
        //   );
        //*enum ın bu regionu yapmasaydık eğer default değeri int dir migrationda int olarak kaydedilir biz burada strig türüne çevirdik
        #endregion
        #region ValueConverter Sınıfı
